...
plt.figure()
ax = plt.gca()
im = ax.imshow(DG.T, cmap=cm.viridis, extent=[minv1,maxv1,minv2,maxv2], origin='lower', aspect='auto') 
#google matplotlib colormaps for color schemes other than "plasma"
plt.title("Free Energy Surface", fontsize=18, weight='bold')
plt.xlabel(x_l,size=16, weight='bold')
plt.ylabel(y_l,size=16, weight='bold')
